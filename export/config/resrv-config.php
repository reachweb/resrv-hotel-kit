...
return [
     ...
     *
     * Resrv Hotel kit default: Offline (bank transfer / pay at property) so the
     * demo runs with zero API keys. The Stripe / Both modules swap this in Phase 8.
     */
    'payment_gateway' => OfflinePaymentGateway::class,
